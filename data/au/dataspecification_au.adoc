...
|*Rights* |{copyright}
|*Identifier* |https://inspire.ec.europa.eu/id/document/tg/au[D2.8.I.4_v3.2.0]
|*Changelog* |{revremark}
|*Language* |{lang}
...
!Extensibility: !none
!Identifier: !http://inspire.ec.europa.eu/codelist/LegalStatusValue
!Values: !The allowed values for this code list comprise only the values specified in the INSPIRE Registry.
!===
|===
...
!Extensibility: !none
!Identifier: !http://inspire.ec.europa.eu/codelist/TechnicalStatusValue
!Values: !The allowed values for this code list comprise only the values specified in the INSPIRE Registry.
!===
|===
...
_https://inspire.ec.europa.eu/schemas/au/5.0/AdministrativeUnits.xsd_
...
_https://inspire.ec.europa.eu/schemas/mu/4.0/MaritimeUnits.xsd_
