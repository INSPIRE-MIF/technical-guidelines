...
The xml schema document is available from _https://inspire.ec.europa.eu/schemas/pf/4.0/ProductionAndIndustrialFacilities.xsd_
...
The xml schema document is available from _https://inspire.ec.europa.eu/draft-schemas/pf-ext/2.0/ProductionAndIndustrialFacilitiesExt.xsd_.
