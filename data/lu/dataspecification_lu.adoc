...
|*Rights* |{copyright}
|*Identifier* |https://inspire.ec.europa.eu/id/document/tg/lu[D2.8.III.4_v3.1.0]
|*Changelog* |{revremark}
|*Language* |{lang}
