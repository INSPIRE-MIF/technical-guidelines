...
:copyright: Public
:revremark: https://github.com/INSPIRE-MIF/technical-guidelines/releases/tag/v2024.
:lang: en
...
|*Rights* |{copyright}
|*Identifier* |https://inspire.ec.europa.eu/id/document/tg/lu[D2.8.III.4_v3.1.1]
|*Changelog* |{revremark}
|*Language* |{lang}
...
!Description: !Member states should make a mapping to this code list.
!Multiplicity: !1
!===
...
!Description: !NOTE This code list contains values that are common to most planning systems.
!Multiplicity: !1
!Stereotypes: !«voidable»
!===
...
!Description: !NOTE For each plan type name a level of spatial plan must be provided using the code list LevelOfSpatialPlanValue
!Extensibility: !any
...
Specification: D2.8.III.4 Data Specification on _Land Use_ – Technical Guidelines
Character set: UTF-8
The xml schema document is available from http://inspire.ec.europa.eu/schemas/elu/4.0/ExistingLandUse.xsd.

*Name: Gridded _Land Use_ GML Application Schema*
Version: 4.0
Specification: D2.8.III.4 Data Specification on _Land Use_ – Technical Guidelines
Character set: UTF-8
The xml schema document is available from _https://inspire.ec.europa.eu/schemas/gelu/4.0/GriddedExistingLandUse.xsd_.
...
Specification: D2.8.III.4 Data Specification on _Land Use_ – Technical Guidelines
Character set: UTF-8
The xml schema document is available from https://inspire.ec.europa.eu/schemas/selu/4.0/SampledExistingLandUse.xsd
...
Specification: D2.8.III.4 Data Specification on _Land Use_ – Technical Guidelines
Character set: UTF-8
The xml schema document is available from https://inspire.ec.europa.eu/schemas/plu/4.0/PlannedLandUse.xsd.
...
|Extensibility: |any
|Identifier: |http://inspire.ec.europa.eu/codelist/SupplementaryRegulationValue
|Values: |The allowed values for this code list comprise any values defined by data providers. The INSPIRE Registry includes recommended values that may be used by data providers. Before creating new terms, please check if one of them can be used.
|===
