...
!The allowed values for this code list comprise only the values specified in "Regulation (EC) No 1893/2006 of the European Parliament and of the Council". INSPIRE Registry includes recommended values that may be used by data providers.
!===
...
!Extensibility: !open
!Identifier: !http://inspire.ec.europa.eu/codelist/StatisticalDataStatusValue
!Values: !The allowed values for this code list comprise the values specified in the INSPIRE Registry and additional values at any level defined by data providers.
!===
...
The xml schema document is available from INSPIRE website: _https://inspire.ec.europa.eu/schemas/pd/4.0/PopulationDistributionDemography.xsd_
