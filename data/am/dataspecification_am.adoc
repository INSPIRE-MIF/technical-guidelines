...
|*Rights* |{copyright}
|*Identifier* |https://inspire.ec.europa.eu/id/document/tg/am[D2.8.III.11_v3.1.1]
|*Changelog* |{revremark}
|*Language* |{lang}
...
The xml schema document is available from _http://inspire.ec.europa.eu/schemas/am/4.0/AreaManagementRestrictionRegulationZone.xsd_.
