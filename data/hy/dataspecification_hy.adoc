...
!URI: !http://inspire.ec.europa.eu/codelist/OriginValue
!===
...
The xml schema document is available from _https://inspire.ec.europa.eu/schemas/hy/5.0/HydroBase.xsd_.
...
_https://inspire.ec.europa.eu/schemas/hy-p/5.0/HydroPhysicalWaters.xsd_.
...
_https://inspire.ec.europa.eu/schemas/hy-n/4.0/HydroNetwork.xsd_.
