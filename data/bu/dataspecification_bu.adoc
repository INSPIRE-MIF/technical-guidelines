...
The xml schema document is available on the INSPIRE website _https://inspire.ec.europa.eu/schemas/bu-base/4.0/BuildingsBase.xsd_.
...
_http://inspire.ec.europa.eu/schemas/bu-core2d/4.0/BuildingsCore2D.xsd_.
...
The xml schema document is available on the INSPIRE website
_http://inspire.ec.europa.eu/schemas/bu-core3d/4.0/BuildingsCore3D.xsd_.
