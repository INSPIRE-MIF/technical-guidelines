...
!Values: !The allowed values for this code list comprise only the values specified in INSPIRE Registry and additional values at any level defined by data providers.
!===
...
!Values: !The allowed values for this code list comprise only the values specified in INSPIRE Registry.
!===
