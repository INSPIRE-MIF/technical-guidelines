...
|*Rights* |{copyright}
|*Identifier* |https://inspire.ec.europa.eu/id/document/tg/ps[D2.8.I.9_v4.0.0]
|*Changelog* |{revremark}
|*Language* |{lang}
...
|ProtectionClassificationValue |Protected Sites Simple |«codeList»
...
!Values: !The allowed values for this code list comprise only the values specified in the INSPIRE Registry and additional values at any level defined by data providers.
!===
...
[cols=","]
!===
!Definition: !Classification and designation types under different schemes.
...
!Values: !The code list can be extended with additional values at any level, i.e. its allowed values comprise the values specified in the INSPIRE Registry and additional values at any level defined by data providers.
!===
...
!Extensibility: !none
!Identifier: !http://inspire.ec.europa.eu/codelist/ProtectionClassificationValue
!Values: !The allowed values for this code list comprise only the values specified in the INSPIRE Registry.
!===
|===    
...
Specification: D2.8.I.9 Data Specification on Protected Sites – Technical Guidelines
Character set: UTF-8
The xml schema document is available from _https://inspire.ec.europa.eu/schemas/ps/5.0/ProtectedSites.xsd_
