...
The xml schema document is available from _https://inspire.ec.europa.eu/schemas/af/4.0/AgriculturalAndAquacultureFacilities.xsd_
...
The xml schema document is available from _https://inspire.ec.europa.eu/draft-schemas/af-ext/2.0/AgriculturalAndAquacultureFacilitiesExtension.xsd_
