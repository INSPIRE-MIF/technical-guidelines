...
:revdate: 2024-07-31
:keywords: INSPIRE Data Specification for the spatial data theme Cadastral Parcels
:producer: INSPIRE Maintenance and Implementation Group (MIG)
:description: This document describes the INSPIRE Data Specification for the spatial data theme Cadastral Parcels
...
[discrete]
== D2.8.I.6 Data Specification on _Cadastral Parcels_ – Technical Guidelines
...
|*Subject* |{keywords}Symbols and abbreviations
|*Publisher* |{producer}
|*Type* |Text
...
|*Rights* |{copyright}
|*Identifier* |https://inspire.ec.europa.eu/id/document/tg/cp[D2.8.I.6_v3.1.1]
|*Changelog* |{revremark}
|*Language* |{lang}
...
[.text-center]
*Figure 3 – UML class diagram: Overview of the external relations of the _Cadastral parcels_ application schema*
...
The xml schema document is available from _https://inspire.ec.europa.eu/schemas/cp/4.0/CadastralParcels.xsd._
