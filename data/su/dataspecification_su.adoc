...
|*Rights* |{copyright}
|*Identifier* |https://inspire.ec.europa.eu/id/document/tg/su[D2.8.III.1_v3.2.0]
|*Changelog* |{revremark}
|*Language* |{lang}
...
_https://inspire.ec.europa.eu/schemas/su-core/4.0/StatisticalUnitCore.xsd_

_https://inspire.ec.europa.eu/schemas/su-grid/4.0/StatisticalUnitGrid.xsd_

_https://inspire.ec.europa.eu/schemas/su-vector/4.0/StatisticalUnitVector.xsd_
...
!Extensibility: !open
!Identifier: !http://inspire.ec.europa.eu/codelist/NUTSLevelValue
!Values: !The allowed values for this code list comprise the values specified in this Annex and additional values at any level defined by data providers. This Annex includes recommended values that may be used by data providers.
!===
