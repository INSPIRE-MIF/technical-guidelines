...
!Extensibility: !open
!Identifier: !http://inspire.ec.europa.eu/codelist/NUTSLevelValue
!Values: !The allowed values for this code list comprise the values specified in this Annex and additional values at any level defined by data providers. INSPIRE Registry includes recommended values that may be used by data providers.
!===
