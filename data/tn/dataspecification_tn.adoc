...
!Extensibility: !none
!Identifier: !https://inspire.ec.europa.eu/codelist/ServiceFacilityValue
!Values: !The allowed values for this code list comprise only the values specified in the INSPIRE Registry.
!===
...
The xml schema document is available from _http://inspire.ec.europa.eu/schemas/tn/5.0/CommonTransportElements.xsd_
...
_http://inspire.ec.europa.eu/schemas/tn-ro/5.0/RoadTransportNetwork.xsd_
...
The xml schema document is available from _https://inspire.ec.europa.eu/schemas/tn-ra/5.0/RailwayTransportNetwork.xsd_
...
The xml schema document is available from
_http://inspire.ec.europa.eu/schemas/tn-c/4.0/CableTransportNetwork.xsd_
...
The xml schema document is available from
_http://inspire.ec.europa.eu/schemas/tn-w/5.0/WaterTransportNetwork.xsd._
...
The xml schema document is available from
_http://inspire.ec.europa.eu/schemas/tn-a/4.0/AirTransportNetwork.xsd_.
