...
!Values: !The allowed values for this code list comprise the values specified in "Reference Portal for Natura 2000 as defined in Commission Implementing Decision 2011/484/EU" and additional values at any level defined by data providers.
!===
...
!Extensibility: !any
!Identifier: !https://inspire.ec.europa.eu/codelist/MediaTypeValue
!Values: !The allowed values for this code list comprise any values defined by data providers. INSPIRE Registry includes recommended values that may be used by data providers.
!===
...
The xml schema document is available on INSPIRE website _https://inspire.ec.europa.eu/schemas/hh/5.0/HumanHealth.xsd_
...
The xml schema document is available on INSPIRE website https://inspire.ec.europa.eu/draft-schemas/hh-sa/3.0rc3/HumanHealthSafety.xsd
