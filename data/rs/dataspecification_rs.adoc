...
The requirements and recommendations related to Map projections are based on the results from the "Map Projections for Europe" workshopfootnote:[The workshop took place on 15/12/2000. See proceedings on http://www.ec-gis.org/sdi/publist/pdfs/annoni-etal2003eur.pdf]. These are:
