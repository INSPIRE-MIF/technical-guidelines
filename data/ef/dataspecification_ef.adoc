...
|*Rights* |{copyright}
|*Identifier* |https://inspire.ec.europa.eu/id/document/tg/ef[D2.8.II/III.7_v3.2.0]
|*Changelog* |{revremark}
|*Language* |{lang}
...
[DS-D2.9] INSPIRE DS-D2.9, Guidelines for the use of Observations & Measurements and Sensor Web Enablement-related standards in INSPIRE Annex II and III data specification development, v1.0, https://knowledge-base.inspire.ec.europa.eu/publications/guidelines-use-observations-measurements-and-sensor-web-enablement-related-standards-inspire_en
...
!Extensibility: !any
!Identifier: !http://inspire.ec.europa.eu/codelist/MediaValue
!Values: !The INSPIRE Regisry includes recommended values that may be used by data providers.
!===
