...
:revdate: 2024-07-31
:keywords: INSPIRE Data Specification for the spatial data theme Energy Resources
:producer: INSPIRE Maintenance and Implementation Group (MIG)
:description: This document describes the INSPIRE Data Specification for the spatial data theme Energy Resources
...
|*Rights* |{copyright}
|*Identifier* |https://inspire.ec.europa.eu/id/document/tg/er[D2.8.III.20_v3.0.0]
|*Changelog* |{revremark}
|*Language* |{lang}
...
The xml schema document is available from _https://inspire.ec.europa.eu/schemas/er-b/4.0/EnergyResourcesBase.xsd_
...
The xml schema document is available from _https://inspire.ec.europa.eu/schemas/er-v/4.0/EnergyResourcesVector.xsd_
...
The xml schema document is available from _https://inspire.ec.europa.eu/schemas/er-c/4.0/EnergyResourcesCoverage.xsd_
...
_https://inspire.ec.europa.eu/draft-schemas/er-s/3.0/EnergyStatistics.xsd_
...
The xml schema document is available from
_[.mark]#http://inspire.ec.europa.eu/draft-schemas/er-c/3.0/EnergyResourcesCoverage.xsd_
