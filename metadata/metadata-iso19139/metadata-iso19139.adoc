...
As for the INSPIRE spatial data services, metadata can be provided using the technical requirements given in this specification, in [TG DownloadS] or in [TG ViewS].

This specification consists of 7 Conformance Classes (see also *Figure 4*), all having as conformance subject a metadata record encoded in ISO 19139 based XML format:
