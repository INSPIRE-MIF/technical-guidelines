...
http://inspire.ec.europa.eu/id/document/tg/metadata-iso19139/2.1.0 (v.2.1.0)
http://inspire.ec.europa.eu/id/document/tg/metadata-iso19139/2.1.1 (this version)
|*Changelog* |{revremark}
|*Language* |{lang}
|===
